...
export class BrokerConfigService {
  ...
  getBrokers(): Observable<any> {
    return this.http
      .get<any>('your-api-endpoint/brokers')
      .pipe(catchError(() => of({ broker: this.dummyBrokers })));
  }
