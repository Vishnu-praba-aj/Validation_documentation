...
def call_llm(filename, content, decorators,repo):
    ...
    prompt = (
        ...
        "Instructions:\n"
        "1. For each class, object, form, or relevant entity, create a level-2 Markdown heading.\n"
        ...
        "5. Combine validation logic from dependencies, decorators, assertions, comments, or utility functions as needed.\n"
