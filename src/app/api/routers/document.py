...
async def extract_fields(
    ...
    client_session_id: str = Form(...), #to handle calcellation
...
async def cancel_analysis(session_id: str = Form(...), service=Depends(get_document_service)):
    await service.cancel_analysis(session_id)
